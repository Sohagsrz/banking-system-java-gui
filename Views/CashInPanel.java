...
public class CashInPanel extends JPanel implements ActionListener {
    ...
    AccountFrame accObj;
    JButton sendBtn;
    CashInPanel(AccountFrame accountFrame){
        this.setLayout(null);
    ...
    private void makeDesign() {
        //heading
        JLabel headingJLabel = new JLabel("Cash In");
        ...
        // input name
       JLabel nameLabel = new JLabel("Enter Personal Number");
