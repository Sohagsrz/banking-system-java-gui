...
public class WithdrawPanel extends JPanel implements ActionListener {
    ...
    AccountFrame accObj;
    JButton sendBtn;
    WithdrawPanel(AccountFrame accountFrame){
        this.setLayout(null);
    ...
    private void makeDesign() {
        ...
        headingJLabel.setFont(new Font("Arial", Font.BOLD , 15));
        this.add(headingJLabel);


        
        // input name
       JLabel nameLabel = new JLabel("Supplier Number");
            ...
            if(result != null && result.length() > 0){
                ...
                if(this.accObj.main.myaccount.getPin().equals(result)){
                   ...
                   this.accObj.main.showAccount();
                    ...
                    sendBtn.setActionCommand("Clicked");
                    sendBtn.setMultiClickThreshhold(1);
